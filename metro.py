...
# Extraer latitud y longitud como columnas separadas
bocas["latitud"] = bocas["geometry"].y
bocas["longitud"] = bocas["geometry"].x

# Eliminar la columna de geometría porque ya no es necesaria
...
try:
    # Guardar en la tabla "bocas_metro"
    bocas.to_sql("bocas_metro", engine, if_exists="replace", index=False)
    print("Datos insertados correctamente en la tabla 'bocas_metro'.")
